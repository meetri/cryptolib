...
class Bittrex(object):
    ...
    def public_get_latest_candle(self,market="USDT-BTC",tickInterval="fiveMin"):
        if starttime is None:
            starttime = int(time.time())
        return self.private_process2("pub/market/GetLatestTick?marketName={}&tickInterval={}".format(market,tickInterval))
